...
<img src="Primeira normalização.png">

## Segunda Normalização

<img src="Segunda normalização.png">

## Terceira normalização

<img src="Terceira normalização.png">
...
CREATE TABLE `endereco` (
  ...
  `tipologadouro` enum('Rua','Avenida','Viela','Estrada','Rodovia','Travessa') NOT NULL,
...
CREATE TABLE `pagamento` (
  ...
  `formapagamento` enum('Dinheiro','Débito','Credito','Pix','Vale Alimentção','Vale Refeição','Voucher','Cartão da loja','Gift Card') NOT NULL,
